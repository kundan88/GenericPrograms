...
{
    public class MaxFloatNumbers
    {
            public float FloatNumber(float num_1, float num_2, float num_3) //Parameterized Method for Comparing Numbers And Find Maximum Float Number
            {
